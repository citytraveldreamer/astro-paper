...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4 my-6 [&_img]:rounded-lg [&_img]:shadow-sm [&_img]:!m-0">
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4 my-6 [&_img]:rounded-lg [&_img]:shadow-sm [&_img]:!m-0">
  ...
  ![白豆蔻爆炒牛肉特寫](../images/phaya-asura/stir-fried-beef-cardamom.jpg)
...
<div class="grid grid-cols-1 sm:grid-cols-3 gap-4 my-6 [&_img]:rounded-lg [&_img]:shadow-sm [&_img]:!m-0 [&_img]:object-cover [&_img]:h-full [&_img]:aspect-[4/5]">
...
<div class="flex overflow-x-auto snap-x snap-mandatory gap-4 pb-6 mt-8 hide-scrollbar [&_img]:w-full [&_img]:h-auto [&_img]:rounded-lg [&_img]:shadow-sm [&_img]:!m-0 [&_img]:pointer-events-none">
  ...
  <figure class="snap-center shrink-0 w-[90%] sm:w-80 m-0 flex flex-col">
    ...
    <figcaption class="text-center text-sm text-muted-foreground mt-3 italic">冰火交融的燒麵包配咖央醬</figcaption>
  </figure>
