...
{/* 餐廳資訊專屬卡片 (運用現有 Tailwind CSS 主題樣式) */}
<RestaurantInfoCard 
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
  <img src="../images/phaya-asura/crab-delight-close-up.jpg" alt="蟹肉黑金杯特寫" class="rounded-lg shadow-sm !m-0" />
  <img src="../images/phaya-asura/banana-blossom-salad.jpg" alt="香蕉花沙律" class="rounded-lg shadow-sm !m-0" />
</div>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
  <img src="../images/phaya-asura/durian-massaman-curry.jpg" alt="生榴槤瑪莎曼咖喱" class="rounded-lg shadow-sm !m-0" />
  <img src="../images/phaya-asura/crispy-marble-goby.jpg" alt="羅望子筍殼魚" class="rounded-lg shadow-sm !m-0" />
</div>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
  <img src="../images/phaya-asura/mali-kiss-cocktail.jpg" alt="Mali kiss 雞尾酒" class="rounded-lg shadow-sm !m-0" />
  <img src="../images/phaya-asura/tom-yum-cocktail.jpg" alt="冬蔭公凍湯 Cocktail" class="rounded-lg shadow-sm !m-0" />
</div>
...
<div class="flex overflow-x-auto snap-x snap-mandatory gap-4 pb-6 mt-8 hide-scrollbar [&_img]:w-full [&_img]:h-auto [&_img]:rounded-lg [&_img]:shadow-sm [&_img]:!m-0 [&_img]:pointer-events-none">
  ...
  <figure class="snap-center shrink-0 w-[90%] sm:w-80 m-0 flex flex-col">
    ...
    <figcaption class="text-center text-sm text-muted-foreground mt-3 italic">鑊氣十足的白豆蔻爆炒牛肉</figcaption>
  </figure>
