...
{/* 使用 Tailwind CSS 打造無干擾橫向滑動軸，並強制關閉點擊放大功能 */}

<div class="flex overflow-x-auto snap-x snap-mandatory gap-4 pb-6 mt-8 hide-scrollbar [&_img]:w-full [&_img]:h-72 [&_img]:object-cover [&_img]:rounded-lg [&_img]:shadow-sm [&_img]:!m-0 [&_img]:pointer-events-none">
