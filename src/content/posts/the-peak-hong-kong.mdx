...
{/* 使用 Tailwind CSS 打造可左右滑動的相片軸 */}

<div class="flex overflow-x-auto snap-x snap-mandatory gap-4 pb-6 mt-8 hide-scrollbar [&_img]:w-full [&_img]:h-64 [&_img]:object-cover [&_img]:rounded-lg [&_img]:shadow-sm [&_img]:!m-0">
  ...
  <figure class="snap-center shrink-0 w-[85%] sm:w-72 m-0 flex flex-col">
    ...
    ![維港高樓特寫](./images/victoria-harbour-12.jpg)
  ...
  <figure class="snap-center shrink-0 w-[85%] sm:w-72 m-0 flex flex-col">
    ...
    ![白加道車站細節](./images/barker-road-station-7.jpg)
