...
{/* Affiliate 1: GetYourGuide (Target: US Tourists wanting authentic HK experiences) */}
<AffiliateCard 
  type="getyourguide"
  title="Complete the Evening: Aqua Luna Victoria Harbour Cruise" 
  description="After enjoying the harbor breeze at dinner, keep the magic going. Hop on the iconic red-sailed Aqua Luna junk boat to witness Hong Kong's dazzling skyline at night. A must-do for first-time visitors." 
  link="/go/victoria-harbor-cruise-gyg" 
  buttonText="Book on GetYourGuide" 
/>
...
<RestaurantInfoCard 
  ...
  googleMapLink="https://maps.app.goo.gl/UUVdKYpakrq9dmXW7"
  igLink="https://www.instagram.com/phaya_asura"
...
{/* Affiliate 2: Booking.com (Target: US Tourists attending Concerts/Events) */}
<AffiliateCard 
  type="booking"
  title="Flying in for a Concert? Stay at Dorsett Kai Tak" 
  description="Skip the post-concert crowds. As the *only* hotel located directly inside the Kai Tak Sports Park, you are literally a 1-minute walk from the main stadium. It features a stunning rooftop infinity pool overlooking Victoria Harbour." 
  link="/go/dorsett-kaitak-en" 
  buttonText="Check Prices on Booking.com" 
/>
...
{/* Affiliate 3: Airalo (Target: US Tourists needing connectivity) */}
<AffiliateCard 
  type="airalo"
  title="Travel Essential: Airalo eSIM for Hong Kong" 
  description="Don't pay exorbitant international roaming fees. Airalo is the most trusted eSIM for US travelers. Download the app, activate it upon landing, and get instant 5G data to navigate the city and post your food pics." 
  link="/go/airalo-hk" 
  buttonText="Get Airalo eSIM" 
/>
